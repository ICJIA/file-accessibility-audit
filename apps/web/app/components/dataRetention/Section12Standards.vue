<template>
  ...
  <section id="standards" class="scroll-mt-8">
    ...
    <ul class="space-y-2 text-sm text-[var(--text-secondary)] list-disc list-inside ml-2">
      ...
      <li>
        <strong>ADA Title II</strong> (U.S. federal law; compliance due April 26, 2027 for public
        entities serving 50,000 or more, and April 26, 2028 for smaller entities and special
        districts) — informs the tool's diagnostic and remediation framing.
      </li>
      <li>
      ...
      <li>
        ...
        period for the <code class="text-xs font-mono">remediation_events</code> audit trail matches
        typical state-agency records-retention schedules. Adjust via configuration if your agency's
        schedule differs.
      </li>
    </ul>
  </section>
...
// (Phase F, task F2: section split) -- 12. Standards & compliance alignment. No reactive state;
