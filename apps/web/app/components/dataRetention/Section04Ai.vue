  ...
  <section id="ai" class="scroll-mt-8">
    ...
    <div class="rounded-xl border-2 border-red-700/50 bg-red-950/15 p-6 sm:p-8">
      ...
      <p class="text-sm text-[var(--text-secondary)] mb-3 leading-relaxed">
        ...
        and pdfjs-dist read a PDF; JSZip and fast-xml-parser read a Word, PowerPoint, or Excel file
        (see § 5). Every one of these libraries is rule-based and deterministic; none of them loads
        or runs a machine-learning model, and none of them make an outbound network call.
      </p>
      <p class="text-sm text-[var(--text-secondary)] mb-3 leading-relaxed">
...
// (Phase F, task F2: section split) -- 4. AI usage statement. No reactive state;
