<template>
    ...
    <section id="security-audits" class="scroll-mt-8">
      ...
      >
        ...
        <p class="text-sm text-[var(--text-secondary)] leading-relaxed">
          The automatic checks introduced in the previous release ran a moment too early and
          reported the service as unavailable when it was in fact starting normally. They now wait
          for the service to respond before checking. This affected only the report printed during
          deployment; the service itself was healthy throughout, which was confirmed independently
          at the time.
          <strong>No change to what data is collected, how it is used, or how long it is kept.</strong>
        </p>
      </article>
      ...
      >
        ...
        <p class="text-sm text-[var(--text-secondary)] leading-relaxed">
          ...
          top of the page to the footer alongside the other reference links. The explanation itself
          is unchanged.
          <strong>No change to what data is collected, how it is used, or how long it is kept.</strong>
        </p>
      </article>
