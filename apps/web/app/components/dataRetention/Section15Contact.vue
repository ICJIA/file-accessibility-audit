<template>
  ...
  >
    <h2 class="text-2xl font-bold text-blue-200 mb-3">15. Contact &amp; questions</h2>
    <p class="text-sm text-[var(--text-secondary)] mb-4 leading-relaxed">
      For questions about this policy, requests for technical details beyond what's documented here,
      requests to inspect a specific job's audit trail, or any concern about how this tool handles
      data:
    </p>
    <div class="space-y-1 text-sm">
      <p class="text-[var(--text-heading)] font-semibold">Innovation and Digital Services (IDS)</p>
...
// (Phase F, task F2: section split) -- 15. Contact & questions. No reactive state;
