...
const HINT_RULES: ReadonlyArray<[ids: readonly string[], key: HintKey]> = [
  ...
  [["6.2-1"], "markInfo"],
  [
    ["7.2-2", "7.2-21", "7.2-22", "7.2-23", "7.2-24", "7.2-25", "7.2-29", "7.2-30", "7.2-31", "7.2-32", "7.2-34"],
    "language",
  ],
  [
    ["7.2-3", "7.2-4", "7.2-5", "7.2-6", "7.2-7", "7.2-8", "7.2-9", "7.2-10", "7.2-11", "7.2-12", "7.2-13", "7.2-14", "7.2-15", "7.2-16", "7.2-36", "7.2-37", "7.2-38", "7.2-39", "7.2-41", "7.2-42", "7.2-43"],
    "table",
  ],
  ...
  [
    ["7.21.3.1-1", "7.21.3.2-1", "7.21.3.3-1", "7.21.3.3-2", "7.21.3.3-3", "7.21.4.1-2", "7.21.5-1", "7.21.6-1", "7.21.6-2", "7.21.6-3", "7.21.6-4", "7.21.8-1"],
    "fontProgram",
  ],
];
...
const ROUTES = {
  ...
  encryption: {
    source: "Publish without restrictive security, or grant accessibility permission when applying it.",
...
const ROUTE_RULES: ReadonlyArray<[ids: readonly string[], key: RouteKey]> = [
  ...
  [["6.2-1"], "markInfo"],
  [
    ["7.2-2", "7.2-21", "7.2-22", "7.2-23", "7.2-24", "7.2-25", "7.2-29", "7.2-30", "7.2-31", "7.2-32", "7.2-33", "7.2-34"],
    "language",
  ],
  [
    ["7.2-3", "7.2-4", "7.2-5", "7.2-6", "7.2-7", "7.2-8", "7.2-9", "7.2-10", "7.2-11", "7.2-12", "7.2-13", "7.2-14", "7.2-15", "7.2-16", "7.2-36", "7.2-37", "7.2-38", "7.2-39", "7.2-41", "7.2-42", "7.2-43"],
