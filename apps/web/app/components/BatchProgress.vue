      ...
      >
        ...
        <div class="flex-shrink-0 w-5 h-5 flex items-center justify-center">
          <div
            ...
            class="w-4 h-4 border-2 border-[var(--border)] border-t-green-500 rounded-full animate-spin"
          />
          <svg
        ...
        <span
          ...
          class="flex-shrink-0 text-xs text-[var(--text-muted)]"
          >Cancelled</span
        >
      </div>
    </div>
