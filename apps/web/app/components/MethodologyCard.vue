...
<template>
  ...
  >
    ...
    >
      Eight categories are weighed against <strong>WCAG 2.2 AA</strong> (a
      ...
      Illinois. Categories that don't apply to Word (reading order, form fields)
    ...
    >
      ...
      <strong>IITAA 2.1 §E205.4</strong> and ADA Title II) — the rules that
      govern non-web document accessibility in Illinois. Categories that don't
      apply (e.g. tables in a document with no tables) are excluded and the
      remaining weights renormalized. This score is the compliance benchmark for
      publication. <strong>PDF/UA-1 (ISO 14289-1)</strong> — a separate ISO
      standard for tagged PDFs — is verified with veraPDF when you run the
