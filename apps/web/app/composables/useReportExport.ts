...
function buildMarkdown(result: ReportResult): string {
  ...
  lines.push('---')
  lines.push('')
  lines.push(`*Report generated by File Accessibility Audit Tool — ${timestamp()}*`)
...
function buildJSON(result: ReportResult): string {
  const report = {
    reportMeta: {
      ...
      tool: 'File Accessibility Audit Tool',
    },
    file: {
...
async function buildDocx(result: ReportResult): Promise<Blob> {
  ...
  detailParagraphs.push(
    new Paragraph({
      children: [
        new TextRun({ text: `Report generated by File Accessibility Audit Tool — ${timestamp()}`, size: 18, font: 'Calibri', italics: true, color: '999999' }),
      ],
      alignment: AlignmentType.CENTER,
    })
  )
...
<div class="container">
  ...
  <div style="margin-top:40px;padding-top:16px;border-top:1px solid #222;text-align:center">
    <p style="font-size:12px;color:#555">Report generated by File Accessibility Audit Tool — ${timestamp()}</p>
  </div>
