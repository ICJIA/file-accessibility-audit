      ...
      <div class="mx-auto max-w-4xl flex items-center justify-between">
        ...
        <div class="flex items-center gap-2 sm:gap-4">
          ...
          <nav aria-label="Site information" class="flex items-center gap-3 sm:gap-4">
            ...
            <!-- Plain <a>, NOT NuxtLink: /trust.html is a static file in
                 public/ (regenerated by `pnpm build-brief`), and a NuxtLink
                 to a non-Vue route renders the SPA 404 — the same trap
                 /status shipped broken twice. Pinned by trustPage.test.ts. -->
            <a
              href="/trust.html"
              class="text-sm text-[var(--text-muted)] hover:text-[var(--text-heading)] transition-colors whitespace-nowrap"
            >
    ...
    <footer class="border-t border-[var(--border)] px-3 sm:px-6 py-4">
      <div class="mx-auto max-w-4xl">
        <div class="flex items-center justify-center gap-4">
          ...
          <span class="text-[var(--border)]">|</span>
          <!-- Plain <a> — /trust.html is a static public/ file, not a Vue
               route (see the header note; pinned by trustPage.test.ts). -->
          <a
            href="/trust.html"
            class="inline-flex items-center gap-1.5 text-xs text-[var(--text-muted)] hover:text-[var(--text-secondary)] transition-colors"
          >
