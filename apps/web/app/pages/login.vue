<template>
  <div class="flex items-center justify-center min-h-[80vh]">
    <div v-if="ready" class="w-full max-w-md">
      <!-- Card -->
      <div
        class="rounded-2xl border border-[var(--border-alt)] bg-[var(--surface-card)] shadow-2xl shadow-black/50 overflow-hidden"
      >
        ...
        <div class="px-8 pt-8 pb-2 text-center">
          <div
            class="inline-flex items-center justify-center w-14 h-14 rounded-full bg-orange-500/10 border border-orange-500/20 mb-4"
          >
            <svg
          ...
          <p class="mt-2 text-sm text-[var(--text-muted)]">
            {{
              otpSent
                ...
                : "Enter your @illinois.gov email to get started"
            }}
          </p>
        </div>
        ...
        <div class="px-8 pb-8 pt-4">
          ...
          <form v-else class="space-y-5" @submit.prevent="verifyOTP">
            <div
              class="bg-green-500/10 border border-green-500/20 rounded-lg px-4 py-3 text-sm text-[var(--status-success)]"
            >
