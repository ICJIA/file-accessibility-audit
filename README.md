...
**2,599 tests** across 169 test files (API 1408, Web 1142, CLI 49). Run all three suites with one summary:
...
| `statusProgressPolicy.test.ts` | 3 | Policy v1.13: § 14's entry for the v1.89.0 status-page aggregates — nothing new collected, distinct-document counts and the 30-day re-audit summary described, the grouped-by-file-name-inside-the-database promise, the no-file-name/fingerprint/individual-score promise, and the fewer-than-five withholding rule; the entry and the status card's own caveat both pass the overclaim guard (name the fields, never deny the data) |
