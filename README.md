...
**2,095 tests** across 131 test files (API 1179, Web 867, CLI 49). Run all three suites with one summary:
...
────────────────────────────────────────────────────────────
  ✔ 2095 tests passed across 131 files
════════════════════════════════════════════════════════════
```
