...
**2,619 tests** across 170 test files (API 1410, Web 1160, CLI 49). Run all three suites with one summary:
...
| `matterhornChecklist.test.ts` | 14 | The landing page's Matterhorn Protocol coverage disclosure (v1.91.0): exactly the protocol's 31 checkpoints in order with the 87+47+2=136 arithmetic; **overclaim guards** — the human-judgment checkpoints (03 Flicker, 04 Color and Contrast, 22 Article Threads) must never claim machine coverage, and Character Mappings (10) stays veraPDF-attributed until the in-house glyph census ships; the flagship in-house checkpoints (26 Security, 31 Fonts) stay engine-attributed; component renders every checkpoint with its coverage chip, the four-mechanism legend, the "Did not run" cross-reference, and noopener external links; and index.vue wiring |
...
<details>
<summary><strong>Earlier per-release reviews</strong> (v1.90.0 → v1.33.0) — click to expand</summary>
