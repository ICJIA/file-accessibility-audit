...
./logs.sh       # Read the activity CSVs / error log — on the server, or from here over SSH (./logs.sh --help)
```
...
├── logs.sh             # Read the activity CSVs / error log in a hurry (see Activity Export)
...
**2,550 tests** across 167 test files (API 1367, Web 1134, CLI 49). Run all three suites with one summary:
