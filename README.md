...
════════════════════════════════════════════════════════════
  ...
  ✔ Web      665 passed (49 files)
  ✔ CLI      49 passed (6 files)
────────────────────────────────────────────────────────────
  ✔ 1833 tests passed across 110 files
════════════════════════════════════════════════════════════
```
...
- **`other` is genuinely populated here**, unlike `FormatCounts.other`. It covers unrelated types (`.jpg`, `.zip`) and files whose extension lies — a `.doc` renamed to `.docx` is caught by content detection but buckets by its *stated* extension, since that is all the SQL can see.
