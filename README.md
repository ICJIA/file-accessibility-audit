...
**2,387 tests** across 147 test files (API 1241, Web 1097, CLI 49). Run all three suites with one summary:
...
| `AnnouncementBanner.test.ts` | 13 | The AnnouncementBanner component - permanent dismissal per announcement id, localStorage key scoping, re-show after clear, WCAG-version gating, and the standing "What's New" heading that marks the banner as recent changes |
